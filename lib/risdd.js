...
this.query = function(queryJSON, callback) {
    mongodbsearch( queryJSON, function(docs){
...
// ---
var mongodbsearch = function(queryJSON, callback) {
    var str = queryJSON['search'],
     collectionName = queryJSON['collection'],
     keyName = queryJSON['key'],
